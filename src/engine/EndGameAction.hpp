...
//
//
// This header file defines the interfaces to the class EndGameAction
//
...
#ifndef __ENDGAMEACTION_H__
#define __ENDGAMEACTION_H__
...
#endif // defined __ENDGAMEACTION_H__
