...
//
//
// This header file defines the interfaces to the class SpriteFactory
//
...
public:
   SpriteFactory(boot::Bootstrap* boot);
   ~SpriteFactory();
  AnimatedSprite* buildSprite(std::string key);
  void  loadSpritesDoc(const std::string& key);

};

};

#endif // defined __SPRITEFACTORY_H__
